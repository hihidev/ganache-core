...
GethApiDouble.prototype.evm_mines = function(numBlocks, callback) {
...
// indicate that `evm_mines` only requires one argument (the callback)
GethApiDouble.prototype.evm_mines.minLength = 1;
